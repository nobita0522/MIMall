...
public class PageInfo {
	...
	private int perPageRecordCount = 6;//每页显示多少条
	...
	public String toString() {
		return "PageInfo [totalRecordCount=" + totalRecordCount + ", perPageRecordCount=" + perPageRecordCount
				+ ", requestPage=" + requestPage + ", begin=" + begin + ", currentPage=" + currentPage + ", end=" + end
				+ ", totalPageCount=" + totalPageCount + ", previousPage=" + previousPage + ", nextPage=" + nextPage
				+ "]";
	}
