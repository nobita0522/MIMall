...
public class Utility {
    ...
    public static String handleStrDate(String payOrCancelTime) {
        String time = payOrCancelTime;
        if (payOrCancelTime.length() > 11) {
    ...
    /**
     * 获得订单的流水号,以天为单位，天数发生改变时，自动将自增序列从 1 开始计数，最大为 99999999
     *
     * @return
     */
    public static synchronized String getPaySerialNumber() {
