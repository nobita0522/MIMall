...
<div>
            ...
            <ul id="topnavbarright">
                ...
                <li id="shopcart"><a href="#">购物车</a>
                    <div id="shopcartbox">
                        ...
                        <div id="hasgoodscart">
                            <div><a class="goods" href="#"><img src="<%=basePath %>resources/mi8.png"><span
                                    class="desc">132</span><span class="price">1799x1</span></a><a class="delete"
                                                                                                   href="#">✖</a></div>
                            <div><a class="goods" href="#"><img src="<%=basePath %>resources/mi8.png"><span
                                    class="desc">132</span><span class="price">1799x1</span></a><a class="delete"
                                                                                                   href="#">✖</a></div>
                            <div id="totalprice"><span>共 <em>1</em> 件商品<span>1799<em>元</em></span></span>
                                <button onclick="window.location.href='http://www.baidu.com'">去购物车结算</button>
                            </div>
                        </div>
                    </div>
                </li>
    ...
    <div id="div4">
        ...
        <div class="content">
            ...
            <div class="proInf">
                ...
                <div class="sale-desc"><%
                    if (productList.get(0).getPDESC() != null) out.write(productList.get(0).getPDESC());%></div>
                ...
                <ul class="step-list">
                    <li class="selected-step"><span><%=productList.get(0).getVERSION()%></span><span
                            class="step-list-price"><%=productList.get(0).getNEWPRICE()%>元</span></li>
                ...
                <ul class="step-list2">
                    <li class="selected-step"><img src='<%=basePath%>resources/img/point_gray.png'
                                                   class="image"/><span><%=productList.get(0).getPCOLOR()%></span></li>
                    <li class="dontselected-step"><img src='<%=basePath%>resources/img/point_blue.png'
                                                       class="image"/><span>巴厘蓝</span></li>
                </ul>
                <ul class="step-list3">
                    <li class="dontselected-step"><img src='<%=basePath%>resources/img/point_gold.png'
                                                       class="image"/><span>流沙金</span></li>
                    <li class="dontselected-step"><img src='<%=basePath%>resources/img/point_pink.png'
                                                       class="image"/><span>樱花粉</span></li>
                </ul>
                ...
                <ul class="step-list4">
                    <li class="SecurityService-selected" id="li1">
                        <div class="SecurityService-content">
                            <img src='<%=basePath%>resources/img/circlecheckBox_selected.png'
                                 class="defalut-checkBox image" id="checkBox1">
                            ...
                            <div class="SecurityService-content-details" style="float: left">
                                ...
                                <div>
                                    <img src='<%=basePath%>resources/img/squarecheckBox_selected.png'
                                         class="defalut-checkBox image" id="checkBox2">
                    ...
                    <li class="SecurityService-default" id="li2">
                        <div class="SecurityService-content">
                            <img src='<%=basePath%>resources/img/circlecheckBox_default.png'
                                 class="defalut-checkBox image" id="checkBox3">
                            <img src='<%=basePath%>resources/img/insurance.jpg' class="insurance"/>
                            <div class="SecurityService-content-details" style="float: left">
                                <div>碎屏保障服务</div>
                                <div class="accident">手机意外碎屏</div>
                                <div>
                                    <img src='<%=basePath%>resources/img/squarecheckBox_default.png'
                                         class="defalut-checkBox image" id="checkBox4">
                                    <span class="SecurityService-problems have-red">我已阅读</span>
                                    <span class="SecurityService-problems terms-problems">服务条款</span>
                                    <span class="SecurityService-problems vertical">|</span>
                                    <span class="SecurityService-problems terms-problems">常见问题</span>
                ...
                <div class="step-title4">
                    <ul class="step-list4">
                        <li class="step-list4-content">
                            <div id="phone-model-data1"><%=productList.get(0).getPNAME()%> <%=productList.get(0).getVERSION()%> <%=productList.get(0).getPCOLOR()%>
                            </div>
                            <div id="phone-model-data2">碎屏保障服务</div>
                            <div id="phone-model-data3">
                                <span>总计 : </span><span><%=productList.get(0).getNEWPRICE()%> 元</span></div>
                        </li>
                    </ul>
                </div>
                ...
                <div class="step-title5">
                    <ul class="step-list5">
                        <li class="selected-step"><span class="textone"><a href="ShoppingCartServlet?pid=<%=productList.get(0).getPID()%>&action=addintoshoppingcart&cartcount=1&requestpage=1">加入购物车</a>
</span></li>
    ...
    <div id="div5">
        <div class="content">
            <h3>特别说明</h3>
            <div>
                <img src='<%=basePath%>resources/img/special_introduction.jpg'
                     style="height: 339px;width: 1224px;margin-top: 1em"/>
            </div>
        </div>
    ...
    <div id="div6">
        <div class="content">
            <h3>官方微信</h3>
            <div>
                <img src='<%=basePath%>resources/img/official_vx.jpg'
                     style="height: 160px;width: 1224px;margin-top: 1em"/>
            </div>
        </div>
    </div>
    ...
    <div id="div7">
        <div class="bottom content">
            ...
            <div class="foot_title">
                ...
                <div class="div5">
                    <a href="#"><img src='<%=basePath%>resources/image/photo15.png' alt="" class="img"/> 520家售后网点</a>
                </div>
    ...
    <div class="foot_bottom">
        <div class="foot_bottom1">
            ...
            <div class="foot_bottom1_2_3">
                <div class="photo19"><img src='<%=basePath%>resources/image/photo19.png' width="78px" height="27px">
                </div>
