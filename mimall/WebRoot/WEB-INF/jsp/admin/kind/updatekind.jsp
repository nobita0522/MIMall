<%@ page language="java" import="java.util.*,com.mimall.vo.Kind" pageEncoding="UTF-8"%>
<%
...
<body>
	...
	<form action="KindServlet" method="post">
		...
		<%
					Kind category2 = (Kind)request.getAttribute("category2");
		...
		<input type="hidden" name="kid" value="<%=category2.getCid()%>"/>
