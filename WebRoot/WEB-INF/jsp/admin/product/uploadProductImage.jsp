<%@ page language="java" import="java.util.*,com.mimall.vo.*" pageEncoding="UTF-8"%>
<%
						...
						<div>
							<div class="listFieldsetDiv">
								<div class="categoryClass1">
									<label>图片1</label><input type="file"  name="cdesc" id="cdesc" class="btn-warning"/>
								</div>
							
								<div class="categoryClass2">
									<label>图片2</label><input type="file"  name="cdesc" id="cdesc" class="btn-warning"/>
								</div> 
							</div>
							
							<div class="listFieldsetDiv">
								<div class="categoryClass3">
									<label>图片3</label><input type="file"  name="cdesc" id="cdesc" class="btn-warning"/>
								</div>
								
								<div class="categoryClass4">
									<label>图片4</label><input type="file"  name="cdesc" id="cdesc" class="btn-warning"/>
								</div> 
							</div>
